...
export class CompanyRegistrationComponent implements OnInit {
  ...
  constructor(public router: Router, public dialog: MatDialog, public http: HttpClient, public httpModule: Http) {
  }
  ...
  register1() {
    ...
    this.http.post(this.url + '/company', body, httpOptions).subscribe(data => {
      console.log(data)
  ...
  register() {
    ...
    this.http.post(this.url + '/customer', body, httpOptions).subscribe(data => {
      console.log(data);
      const dialogRef = this.dialog.open(AlertPopupComponent, {
        width: '350px', height: '300px',
        data: {
